        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="space-y-2 font-sans text-sm text-white/55">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a href="https://www.instagram.com/lyfefitnessli/" target="_blank" rel="noreferrer" aria-label="Instagram" className="text-white/50 transition hover:text-white">
              ...
              <a href="https://www.facebook.com/lyfefitnessli" target="_blank" rel="noreferrer" aria-label="Facebook" className="text-white/50 transition hover:text-white">
